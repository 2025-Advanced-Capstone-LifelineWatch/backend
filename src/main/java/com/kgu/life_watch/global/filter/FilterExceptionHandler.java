 ...
 * 전역 필터 예외 처리 클래스
 *
 * Spring Security 또는 Servlet Filter에서 발생한 예외를 잡아,
 * 사용자에게 일관된 JSON 에러 응답을 반환하기 위한 필터입니다.
 * 커스텀 예외(LifelineException)는 정의된 에러 코드에 따라 처리되며,
 * 그 외 예외는 내부 서버 오류(500)로 응답합니다.
 */
@Slf4j
